...
# Tap = speed (tuning)
@export var power_per_tap: float = 1.0      # 1.0 tap power added per Space press
@export var power_decay: float = 2.5        # tap power lost per second
@export var speed_per_power: float = 2000.0  # 200.0 , horizontal speed per 1.0 tap power
@export var max_speed: float = 2000.0       #2000.0 speed clamp
